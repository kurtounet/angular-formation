...
export const mockMangas: IManga[] = [ 
    ...
    { title: 'Death Note', author: 'Tsugumi Ohba', genre: 'Shonen', volumes: 12, published: '2003-2006' }, 
    { title: 'Fullmetal Alchemist', author: 'Hiromu Arakawa', genre: 'Shonen', volumes: 27, published: '2001-2010' } ];